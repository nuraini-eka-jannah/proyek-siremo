...
<style>
    ...
    .foto-placeholder span { font-size: 12px; }
    ...
    <form action="{{ route('admin.kendaraan.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-6">
                ...
                <input type="text" name="merek" class="form-control @error('merek') is-invalid @enderror"
                       value="{{ old('merek') }}" placeholder="Toyota, Honda, Daihatsu ...">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="model" class="form-control @error('model') is-invalid @enderror"
                       value="{{ old('model') }}" placeholder="Avanza, Brio, Xenia ...">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="plat_nomor" class="form-control @error('plat_nomor') is-invalid @enderror"
                       value="{{ old('plat_nomor') }}" placeholder="E 1212 QS"
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="warna" class="form-control @error('warna') is-invalid @enderror"
                       value="{{ old('warna') }}" placeholder="Black, White, Silver ...">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="tarif_sewa_per_hari"
                       ...
                       value="{{ old('tarif_sewa_per_hari') }}" min="0" placeholder="500000">
            ...
            <div class="col-md-4">
                ...
                <select name="status_ketersediaan"
                    ...
                    @foreach(['Tersedia','Disewa','Perawatan'] as $s)
                        <option value="{{ $s }}" {{ old('status_ketersediaan', 'Tersedia') == $s ? 'selected' : '' }}>
                            {{ $s }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-12">
                ...
                <textarea name="deskripsi" rows="3"
                          ...
                          placeholder="Tuliskan deskripsi kendaraan ...">{{ old('deskripsi') }}</textarea>
        ...
        <div class="d-flex gap-3 align-items-center">
            <button type="submit" class="btn-simpan">
                <i class="bi bi-floppy-fill me-1"></i> Simpan Kendaraan
            </button>
