...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Tombol toggle & clear di kanan input password */
        .pw-actions {
            position: absolute;
            right: 14px;
            display: flex;
        ...
        .btn-signup:hover  { background: #A8660F; }
...
<div class="side-left">
    {{-- Ganti src dengan foto kantor SIREMO jika ada --}}
...
<div class="side-right">
    ...
    <form class="form-wrap" method="POST" action="{{ route('register') }}">
        ...
        {{-- Confirm Password --}}
        <div class="field-group">
            <label class="field-label" for="password_confirmation">Conf password :</label>
            <div class="field-input-wrap">
                <i class="bi bi-key field-icon"></i>
                <input type="password" id="password_confirmation" name="password_confirmation"
                       ...
                       autocomplete="new-password" required>
                <div class="pw-actions">
                    <button type="button" class="pw-btn" onclick="clearField('password_confirmation')" title="Hapus">
                        <i class="bi bi-x-circle"></i>
                    </button>
                    <button type="button" class="pw-btn" onclick="togglePw('password_confirmation', this)" title="Lihat">
                        <i class="bi bi-eye-slash"></i>
                    </button>
                </div>
            </div>
